...
*
* @usage // Create Image From File
*
* $this->loadLibary('image');
*
* $this->img->createFromFile('img/a.jpg');	// Create image from file	file : a.jpg
* $this->img->resize(200, 0);			    // Scale image	width: 200px
*
* $this->img->show();				        // Show result
* $this->img->save('results/resized.jpg');	// Save result	file: results/resized.jpg
**/

/**
* @usage // Other helpful functions
*
* hex2rgb($hex)
* Get rgb color from hex code
*    
* createFromFile($path)
* Create your image from a file
*    
* create($width, $height, [ $background ])
* Create your image with background color or transparent
*    
* resize($width, $height)
* Resize your image, set one value 0 to scale
*    
* crop($x, $y, $width, $height)
* Crop a part of the image
*    
* rotate($angle)
* Rotate image, only available if your PHP is compiled with the bundled version of the GD library
*    
* rectangle($x1, $y1, $x2, $y2, $color)
* Draw a rectangle on your image
*    
* ellipse($x, $y, $width, $height, $color)
* Draw a ellipse on your image
*    
* polygon($points, $color)
* Draw a polygon on your image, $points is an array of coordinates, e.g. array($x1, $y1, $x2, $y2, $x3, $y3)
*    
* line($points, $color)
* Draw a line on your image, $points is an array of coordinates, e.g. array($x1, $y1, $x2, $y2)
*    
* write($x, $y, $font, $size, $angle, $color, $text)
* Write text on your image, $font is the path to a TrueType-file
*
* merge($img, $x, $y)
* Put another image on your image, $img is a Image object
*
* show([ $type ])
* Display your image, you can define the filetype, e.g. png
*
* save($path)
* Save your image in a writable directory
**/
...
class Image {
	...
	/**
	*
	* Holds img instance when loaded
	*
	**/
	public $img;
