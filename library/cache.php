...
* $result = $this->cache->retrieve('movies');
*
...
* echo $this->cache->eraseExpired() . ' expired items erased!';
* 
* // Check cached data returns boleen
* $this->cache->isCached($key);
*
* // Set cache name
* $this->cache->setCache($name);
*
* // Set cache path
* $this->cache->setCachePath($path);
*
* // Get cache file path. returns sh1 encoded: cache/7505d64a54e061b7acd54ccd58b49dc43500b635.cache
...
class Cache 
{
  ...
  **/
  ...
  {
    $this->_cachepath = dirname(dirname(__FILE__)) . '\tmp\cache/';
