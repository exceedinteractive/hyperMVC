...
/**
 * Hyper Database Class
 **/

/**
* @usage Retrieve results of a standard query
*
...
*
* $query = "SELECT col_id, col_name, col_parent FROM table WHERE col_name LIKE '%Awesome%'";
* if($db->num_rows($query) > 0) {
*    list( $id, $name, $parent ) = $db->get_row($query);
*    echo "<p>With an ID of $id, $name has a parent of $parent</p>";
* } else {
*    echo 'No results found for a column name like &quot;Awesome&quot;';
* }
**/
...
* $names = array(
*    'group_parent' => 18,
*    'group_name' => mt_rand(0, 500)
* );
* $add_query = $db->insert('table', $names);
* if($add_query) {
...
* );
*
* $updated = $db->update( 'table', $update, $where_clause, 1 );
* if( $updated ) {
...
* );
*
* $deleted = $db->delete('table', $delete, 1);
* if($deleted) {
...
class Database
{
    ...
    **/
    ...
    public function __construct()
    {
        ...
        try {
            $this->link = new mysqli( DATABASE_SERVER, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
