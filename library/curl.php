...
*
* $this->curl->setMaxRedirect($max_redirect);
*
* $opt = array(
...
* );
*
* $this->curl->setDefaultOptions($opt);
*
* $this->curl->setResponseSequenceFlag(true);  // Skipable: default => false
* $this->curl->setMetaRedirectFlag(false);     // Skipable: default => true
* $this->curl->setCompression('gzip,deflate'); // Skipable: default => ''
* 
...
* echo $this->curl->currentResponse('body');
* 
* $cookies = $this->curl->getCurrentCookies();
* print_r($cookies);
* 
* echo $this->curl->getCurrentCookies('session_key');
**/
